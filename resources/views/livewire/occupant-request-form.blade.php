<div>
    @if($submitted)
        ...
        <div class="text-center py-10">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-sm mx-auto mb-6">
                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Your Tracking Code</p>
                <p class="text-3xl font-mono font-bold text-brand-600 tracking-widest">{{ $trackingToken }}</p>
        ...
        <form wire:submit="submit" class="space-y-6">
                ...
                <div class="px-5 py-4 space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="name" wire:model="requesterName" placeholder="John Smith"
                                class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 focus:outline-none">
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" wire:model="requesterPhone" placeholder="(555) 123-4567"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 focus:outline-none sm:max-w-xs">
                ...
                <div class="px-5 py-4 space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="project" wire:model.live="projectId"
                                class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 focus:outline-none">
                    ...
                    <div>
                        ...
                        <select id="category" wire:model="category"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 focus:outline-none sm:max-w-xs">
            ...
            <div class="flex justify-end">
                <button type="submit" wire:loading.attr="disabled"
                    class="inline-flex items-center gap-2 rounded-lg bg-brand-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 transition-colors disabled:opacity-50">
