...
<div class="flex h-full">
    ...
    <aside class="w-64 bg-sidebar flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 px-3 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('fpt.scripts.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                {{ request()->routeIs('fpt.*') ? 'bg-sidebar-active text-white' : 'text-gray-400 hover:bg-sidebar-hover hover:text-gray-200' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('fpt.*') ? 'text-brand-400' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('deficiencies.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                {{ request()->routeIs('deficiencies.*') ? 'bg-sidebar-active text-white' : 'text-gray-400 hover:bg-sidebar-hover hover:text-gray-200' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('deficiencies.*') ? 'text-brand-400' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                </svg>
                Deficiency Board
            </a>

            <a href="{{ route('lessons-learned.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                {{ request()->routeIs('lessons-learned.*') ? 'bg-sidebar-active text-white' : 'text-gray-400 hover:bg-sidebar-hover hover:text-gray-200' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('lessons-learned.*') ? 'text-brand-400' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('reports.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                {{ request()->routeIs('reports.index') ? 'bg-sidebar-active text-white' : 'text-gray-400 hover:bg-sidebar-hover hover:text-gray-200' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('reports.index') ? 'text-brand-400' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                </svg>
                Reports
            </a>

            <a href="{{ route('reports.commissioning') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                {{ request()->routeIs('reports.commissioning') ? 'bg-sidebar-active text-white' : 'text-gray-400 hover:bg-sidebar-hover hover:text-gray-200' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('reports.commissioning') ? 'text-brand-400' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
